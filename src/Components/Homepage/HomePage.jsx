  ...
  return (
    <Box>
      <Container mb={'28px'} h={'80px'} maxW={'100%'}>
        <Heading fontFamily={'Inherit'} textAlign={'center'} fontWeight={'700'} fontSize={'35px'} lineHeight={'50px'} mb={'6px'} mt={'104px'}>
          Tìm việc làm nhanh 24h, việc làm mới nhất
        </Heading>
      </Container>
      <Box bg='blue.100' py={5}>
      <Container h={'70px'} maxW={'100%'}>
        <Flex boxShadow='base' p='6' rounded='md' bg='white' w={'1270px'} h={'100%'} m={'auto'} borderRadius={'50px'} pl={'24px'} pr={'9px'} py={'9px'}>
